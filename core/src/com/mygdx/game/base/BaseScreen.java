...
public class BaseScreen implements Screen, InputProcessor {
    ...
    private Matrix4 worldToGl;  //матрица проекции из нашей сист коорд в сетку OpenGl
    ...
    public void show() {
        ...
        glBounds = new Rect(0,0,1f,1f); //размеры коорд сетки OpenGl известны 2f x 2f
    ...
    @Override
    public void resize(int width, int height) {  //при изменении размеров экрана //рассчитаем размеры коорд сеток screenBounds и worldBounds
